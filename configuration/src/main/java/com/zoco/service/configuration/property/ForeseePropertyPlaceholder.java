package com.zoco.service.configuration.property;

import com.zoco.service.configuration.constants.ConfigurationConstants;
import com.zoco.service.configuration.utils.HttpClientConnectionManager;
...
public class ForeseePropertyPlaceholder extends PropertyPlaceholderConfigurer {
	...
	public ForeseePropertyPlaceholder(){
		String delay = getDbProperty("com.zoco.conf.refresh.delay");
		int de = 60;
		if(delay == null){
