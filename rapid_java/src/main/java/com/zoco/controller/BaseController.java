...
public class BaseController extends MultiActionController {
	 ...
	 * @return
	 */
	protected Integer getParameterToIntRetNull(HttpServletRequest request, String para) throws RapidException {
		Integer parameter = null;
		Object object = request.getParameter(para);
		if (null != object) {
			try{
				parameter = new Integer(object.toString());	
			}catch (RapidException e) {
				log.error("获取参数值，并转换为int类型异常，AdminException异常信息为{}", e.getMessage(), e);
				throw new RapidException("获取参数值，并转换为int类型异常", e);
			}
		}
		return parameter;
	}
	 ...
	 * @return
	 */
	protected Double getParameterToDoubleRetNull(HttpServletRequest request, String para) throws RapidException {
		...
		if (null != object) {
			try{
				...
				throw new RapidException("获取参数值，并转换为double类型异常", e);
			}
		}
		return parameter;
	}
	 ...
	 * @return
	 */
	protected String getParamStr(HttpServletRequest request, String para) throws RapidException {
		try {
			request.setCharacterEncoding("utf-8");
		} catch (UnsupportedEncodingException e) {
			log.error("增加获取字符串参数方法异常，AdminException异常信息为{}", e.getMessage(), e);
			throw new RapidException("增加获取字符串参数方法异常", e);
		}
	...
	protected void renderJson(HttpServletResponse response,String jsonResponse) throws RapidException {
